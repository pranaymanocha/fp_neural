...
%C=cell(200,1);
path='/usr2/elizalde/NELS/users/rohan/fingerprinting/youtube_all/youtube_batch_2/';
dirData12 = dir('/usr2/elizalde/NELS/users/rohan/fingerprinting/youtube_all/youtube_batch_2/**/*.wav');
%disp(dirData12)
cqw=[]
for i=1:length(dirData12)
%disp(dirData12(i).folder)
a=strsplit(dirData12(i).folder,'/');
b=a(10);
%disp(b{1})
